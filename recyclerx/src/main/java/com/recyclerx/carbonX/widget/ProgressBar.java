...
import com.recyclerx.carbonX.drawable.CircularProgressDrawable;
import com.recyclerx.carbonX.drawable.DefaultPrimaryColorStateList;
import com.recyclerx.carbonX.drawable.ProgressBarDrawable;
import com.recyclerx.carbonX.drawable.ProgressDrawable;
...
public class ProgressBar extends View implements AnimatedView, TintedView {
    ...
    public ProgressBar(Context context, AttributeSet attrs) {
        super(CarbonX.getThemedContext(context, attrs, R.styleable.ProgressBarX, android.R.attr.progressBarStyle, R.styleable.ProgressBarX_carbonX_theme), attrs);
        initProgressBar(attrs, android.R.attr.progressBarStyle);
    }

    public ProgressBar(Context context, AttributeSet attrs, int defStyleAttr) {
        super(CarbonX.getThemedContext(context, attrs, R.styleable.ProgressBarX, defStyleAttr, R.styleable.ProgressBarX_carbonX_theme), attrs, defStyleAttr);
        initProgressBar(attrs, defStyleAttr);
    }

    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    public ProgressBar(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        super(CarbonX.getThemedContext(context, attrs, R.styleable.ProgressBarX, defStyleAttr, R.styleable.ProgressBarX_carbonX_theme), attrs, defStyleAttr, defStyleRes);
        initProgressBar(attrs, defStyleAttr);
    }

    private static int[] animationIds = new int[]{
            R.styleable.ProgressBarX_carbonX_inAnimation,
            R.styleable.ProgressBarX_carbonX_outAnimation
    };
    private static int[] tintIds = new int[]{
            R.styleable.ProgressBarX_carbonX_tint,
            R.styleable.ProgressBarX_carbonX_tintMode,
            R.styleable.ProgressBarX_carbonX_backgroundTint,
            R.styleable.ProgressBarX_carbonX_backgroundTintMode,
            R.styleable.ProgressBarX_carbonX_animateColorChanges
    };

    private void initProgressBar(AttributeSet attrs, int defStyleAttr) {
        TypedArray a = getContext().obtainStyledAttributes(attrs, R.styleable.ProgressBarX, defStyleAttr, R.style.carbonX_ProgressBar);
        Style style = Style.values()[a.getInt(R.styleable.ProgressBarX_carbonX_progressStyle, 0)];
        ...
        drawable.setBarWidth(a.getDimension(R.styleable.ProgressBarX_carbonX_barWidth, 5));
