...
import com.recyclerx.carbonX.internal.ElevationComparator;
import com.recyclerx.carbonX.internal.MatrixHelper;
import com.recyclerx.carbonX.internal.PercentLayoutHelper;
...
public class FrameLayout extends android.widget.FrameLayout implements ShadowView, RippleView, TouchMarginView, StateAnimatorView, AnimatedView, InsetView, CornerView, MaxSizeView {
    ...
    public FrameLayout(Context context) {
        super(context, null, R.attr.carbonX_frameLayoutStyle);
        initFrameLayout(null, R.attr.carbonX_frameLayoutStyle);
    }

    public FrameLayout(Context context, AttributeSet attrs) {
        super(CarbonX.getThemedContext(context, attrs, R.styleable.FrameLayoutX, R.attr.carbonX_frameLayoutStyle, R.styleable.FrameLayoutX_carbonX_theme), attrs, R.attr.carbonX_frameLayoutStyle);
        initFrameLayout(attrs, R.attr.carbonX_frameLayoutStyle);
    }

    public FrameLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        super(CarbonX.getThemedContext(context, attrs, R.styleable.FrameLayoutX, defStyleAttr, R.styleable.FrameLayoutX_carbonX_theme), attrs, defStyleAttr);
        initFrameLayout(attrs, R.attr.carbonX_frameLayoutStyle);
    }

    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    public FrameLayout(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        super(CarbonX.getThemedContext(context, attrs, R.styleable.FrameLayoutX, defStyleAttr, R.styleable.FrameLayoutX_carbonX_theme), attrs, defStyleAttr, defStyleRes);
        initFrameLayout(attrs, defStyleAttr);
    }

    private static int[] rippleIds = new int[]{
            R.styleable.FrameLayoutX_carbonX_rippleColor,
            R.styleable.FrameLayoutX_carbonX_rippleStyle,
            R.styleable.FrameLayoutX_carbonX_rippleHotspot,
            R.styleable.FrameLayoutX_carbonX_rippleRadius
    };
    private static int[] animationIds = new int[]{
            R.styleable.FrameLayoutX_carbonX_inAnimation,
            R.styleable.FrameLayoutX_carbonX_outAnimation
    };
    private static int[] touchMarginIds = new int[]{
            R.styleable.FrameLayoutX_carbonX_touchMargin,
            R.styleable.FrameLayoutX_carbonX_touchMarginLeft,
            R.styleable.FrameLayoutX_carbonX_touchMarginTop,
            R.styleable.FrameLayoutX_carbonX_touchMarginRight,
            R.styleable.FrameLayoutX_carbonX_touchMarginBottom
    };
    private static int[] insetIds = new int[]{
            R.styleable.FrameLayoutX_carbonX_inset,
            R.styleable.FrameLayoutX_carbonX_insetLeft,
            R.styleable.FrameLayoutX_carbonX_insetTop,
            R.styleable.FrameLayoutX_carbonX_insetRight,
            R.styleable.FrameLayoutX_carbonX_insetBottom,
            R.styleable.FrameLayoutX_carbonX_insetColor
    };
    private static int[] maxSizeIds = new int[]{
            R.styleable.FrameLayoutX_carbonX_maxWidth,
            R.styleable.FrameLayoutX_carbonX_maxHeight,
    };

    private void initFrameLayout(AttributeSet attrs, int defStyleAttr) {
        TypedArray a = getContext().obtainStyledAttributes(attrs, R.styleable.FrameLayoutX, defStyleAttr, R.style.carbonX_FrameLayout);
        CarbonX.initRippleDrawable(this, a, rippleIds);

        CarbonX.initElevation(this, a, R.styleable.FrameLayoutX_carbonX_elevation);
        CarbonX.initAnimations(this, a, animationIds);
        CarbonX.initTouchMargin(this, a, touchMarginIds);
        CarbonX.initInset(this, a, insetIds);
        CarbonX.initMaxSize(this, a, maxSizeIds);
        setCornerRadius((int) a.getDimension(R.styleable.FrameLayoutX_carbonX_cornerRadius, 0));
    ...
    public static class LayoutParams extends android.widget.FrameLayout.LayoutParams implements PercentLayoutHelper.PercentLayoutParams {
        ...
        public LayoutParams(Context c, AttributeSet attrs) {
            ...
            TypedArray a = c.obtainStyledAttributes(attrs, R.styleable.FrameLayoutX_Layout);
            anchorView = a.getResourceId(R.styleable.FrameLayoutX_Layout_carbonX_anchor, -1);
            anchorGravity = a.getInt(R.styleable.FrameLayoutX_Layout_carbonX_anchorGravity, -1);
            a.recycle();
