package com.recyclerx.carbonX.animation;
...
public class AnimUtils {
    ...
    public static ValueAnimator flyIn(final View view, Animator.AnimatorListener listener) {
        ...
        animator.addUpdateListener(valueAnimator -> {
            ViewHelper.setAlpha(view, (Float) valueAnimator.getAnimatedValue());
            ViewHelper.setTranslationY(view, Math.min(view.getHeight() / 2, view.getResources().getDimension(R.dimen.carbonX_1dip) * 50.0f) * (1 - (Float) valueAnimator.getAnimatedValue()));
            if (view.getParent() != null)
                ((View) view.getParent()).postInvalidate();
        });
        animator.start();
    ...
    public static void setupElevationAnimator(StateAnimator stateAnimator, final ShadowView view) {
        {
            ...
            Animator.AnimatorListener animatorListener = new AnimatorListenerAdapter() {
                ...
                public void onAnimationStart(Animator animation) {
                    animator.setFloatValues(view.getTranslationZ(), ((View) view).getResources().getDimension(R.dimen.carbonX_elevationLow));
                }
            };
